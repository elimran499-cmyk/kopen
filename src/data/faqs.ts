...
export const FAQS_DATA: FAQItem[] = [
  {
    id: 'activation-speed',
    question: 'Hoe snel wordt mijn IPTV Koning account geactiveerd?',
  ...
  },
  {
    ...
    answer: 'Nee, absoluut niet! IPTV Koning werkt 100% via internet. Je hebt alleen een internetverbinding nodig en een apparaat zoals een Smart TV, Amazon Firestick, Android box, Apple TV, tablet, smartphone of computer.'
  },
  {
    id: 'internet-speed',
  ...
  },
  {
    ...
    question: 'Op welke apparaten en apps kan ik IPTV Koning gebruiken?',
    answer: 'IPTV Koning is compatibel met vrijwel elk modern scherm: Samsung & LG Smart TV (via IBO Player, Nanomid of Smart One), Android TV, Amazon Fire Stick (via IPTV Smarters Pro of XCIPTV), Apple TV (via GSE of TiviMate), iOS, Android telefoons en Windows/Mac.'
  },
  {
    id: 'sports-channels',
