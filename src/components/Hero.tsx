...
export const Hero: React.FC<HeroProps> = ({ onOpenCheckoutModal }) => {
  return (
    <section className="relative bg-canvas overflow-hidden pt-24 pb-64 sm:pb-72 lg:pt-28 lg:pb-0 lg:min-h-[94vh] flex items-center">
      ...
      {/* ---------- Right side panel (lg+): ring, gold slab and the film strip ---------- */}
      <div className="pointer-events-none absolute inset-y-0 right-0 w-[46%] hidden lg:block">
        ...
        {/* Gold slab anchored to the right edge, bleeding off right and bottom */}
      ...
      <div className="lg:hidden absolute inset-x-0 bottom-0 h-56 sm:h-64 z-[1] pointer-events-none">
        ...
        {/* Gold slab bleeding off the right and bottom edges. Kept narrow enough
            that the poster columns cover it rather than leaving bare gold. */}
        ...
        {/* Poster columns standing in front of the slab. Flush to the right edge
            with a hairline gap, so the gold never shows as stripes between them. */}
        ...
        <div className="lg:max-w-[58%]">
          ...
          <div className="relative inline-block">
            ...
            <div className="relative">
              ...
              {/* The wordmark is branding, not the page's subject. It keeps its
                  styling but hands the H1 down to the line that says what we sell. */}
              <p className="font-display font-extrabold text-ink uppercase leading-[0.82] text-[3.25rem] sm:text-7xl lg:text-[6.5rem] tracking-[-0.03em]">
                {/* Line 1 — indented so the quote and tag have a margin to sit in,
                    with the gold lozenge riding behind its upper band */}
                <span className="relative inline-block ml-[0.6em] sm:ml-[1.15em] lg:ml-[1.6em]">
                  ...
                  />
                  <span className="relative">IPTV</span>
                </span>
                <br />
                {/* Line 2 — flush left, closing on the gold full stop */}
                <span className="relative">
                  Koning<span className="text-brand">.</span>
                </span>
              </p>
            </div>
          </div>

          <h1 className="mt-8 sm:mt-10 text-base sm:text-lg text-ink-soft leading-relaxed max-w-lg font-medium">
            Premium IPTV in Nederland — alle Nederlandse zenders, complete sportpakketten en de
            nieuwste films en series op elk apparaat, zonder schotel, zonder kabel en zonder
            buffering.
          </h1>
          ...
          <div className="mt-8 sm:mt-10 lg:mb-14 flex items-center gap-3">
            ...
            <span className="font-display font-extrabold text-ink text-sm sm:text-base">
              IPTV Koning · 4.9/5 uit 1.400+ reviews
            </span>
          </div>
