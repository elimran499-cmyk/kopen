          ...
          <div className="mt-6 text-center">
            {!isChecked ? (
              <button
                ...
                disabled={isChecking}
                className="px-8 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-sm rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 mx-auto"
              >
                {isChecking ? (
                  <>
              ...
              <div className="bg-emerald-950/80 border border-emerald-500/50 p-5 rounded-2xl max-w-md mx-auto space-y-3 animate-fade-in">
                <div className="flex items-center justify-center gap-2 text-emerald-400 font-extrabold text-base">
                  ...
                  <span>100% GESCHIKT VOOR IPTV KONING 4K!</span>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-sm rounded-xl shadow-md transition-all flex items-center justify-center gap-2"
                >
